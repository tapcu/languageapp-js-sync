...
export class DatabaseService {
    ...
    public upsertWord(word: WordEntryDto){
        this.db.serialize(()=>{
            this.db.run(`
                INSERT INTO words (id, word, translation, correct_answers, iteration, next_show_date)
                  VALUES (?,?,?,?,?,?)
            ...
            `,
                [word.id, word.word, word.translation, word.correct_answers, word.iteration, word.next_show_date],
